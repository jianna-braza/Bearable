      ...
      <form className="tw-bg-white tw-rounded-lg tw-shadow-2xl tw-w-1/4">
        ...
        <div className="tw-p-3">
          <div className="tw-grid tw-grid-cols-1/5 tw-items-end tw-gap-y-7">
            ...
            <input
              ...
              value={title}
              required
              className="tw-pt-3 tw-border-0 tw-text-gray-600 tw-text-xl tw-font-semibold tw-pb-2 tw-w-full tw-border-b-2 tw-border-gray-200 focus:tw-outline-none focus:tw-ring-0 focus:tw-border-blue-500"
            ...
            <input
              ...
              value={description}
              required
              className="tw-pt-3 tw-border-0 tw-text-gray-600 tw-pb-2 tw-w-full tw-border-b-2 tw-border-gray-200 focus:tw-outline-none focus:tw-ring-0 focus:tw-border-blue-500"
              onChange={(e) => setDescription(e.target.value)}
            />
            <span className="material-icons-outlined tw-text-gray-400">
              bookmark_border
            </span>
        ...
        <footer className="tw-flex tw-justify-end tw-border-t tw-p-3 tw-mt-5">
          <button
            ...
            className="tw-bg-blue-500 hover:tw-bg-blue-600 tw-px-6 tw-py-2 tw-rounded tw-text-white"
          >
            Save
          </button>
        </footer>
